    ...
    <main class="main">
        ...
        <div class="container">
            ...
            <div class="gallery d-flex align-items-center flex-column mb-200">
                ...
                <img
                    :src="currentImage"
                    :alt="studentworks ? 'students-paintings' : 'my-paintings'"
                    class="adaptive-img"
                />
            </div>
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="about-description">
                            ...
                            based in Calgary. I am continuously inspired by world we live in and can never resist putting this beauty
                            on a canvas.
                        </div>
                        <div class="about-description">
                            My preferred art style is realism and I have academic knowledge and practical experience of applying it in
                            painting, drawing, and compositions. Along with my students I work on creating portraits, landscapes,
                            architecture stills, and a lot more.
                        </div>
                        <div class="about-description">
                            However, I’m always open to exploring new styles, approaches, and techniques. I believe that there are
                            limitless possibilities when it comes to art and I want to inspire my students to experiment and express
                            themselves.
                        </div>
                        <div class="about-description">
                            Let’s get creative!
                    ...
                    <div class="col-1"></div>
                    <div class="col-5">
                        <img src="assets/img/photo-about-the-author.png" alt="photo-about-the-author" class="adaptive-img">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-6 d-flex align-items-end">
                        <div class="input-group">
                            ...
                            <button class="subscribe-button btn btn-outline-secondary" type="button" id="button-addon2">Subscribe</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-5">
                        ...
                        <form class="d-flex flex-column">
                            ...
                            <textarea id="message" v-model="form.message" class="message-input message-input-text" required></textarea>
                        ...
                        <div class="accordion" id="accordionExample">
                            <div class="accordion-item">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        Don’t worry! I will find an individual approach to each student based on their level of experience.»
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        All materials and supplies are included in the cost of the workshop. The high quality
                            ...
                            <div class="accordion-item mb-0">
                                ...
                                <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        The average length of the class is 3 hours, but of course students can work at different paces.
                                        I will monitor the process so that you have a finished work. The remaining time can be spent
    ...
    computed: {
        currentImage() {
            return this.studentworks
                ? "assets/img/student-paintings.png"
                : "assets/img/my-paintings.png";
        },
        isFormValid() {
